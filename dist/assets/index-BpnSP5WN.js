 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ym;function yw(){if(Ym)return ka;Ym=1;var i=Bd(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),s=Object.prototype.hasOwnProperty,o=i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,l={key:!0,ref:!0,__self:!0,__source:!0};function h(m,g,_){var w,T={},C=null,j=null;_!==void 0&&(C=""+_),g.key!==void 0&&(C=""+g.key),g.ref!==void 0&&(j=g.ref);for(w in g)s.call(g,w)&&!l.hasOwnProperty(w)&&(T[w]=g[w]);if(m&&m.defaultProps)for(w in g=m.defaultProps,g)T[w]===void 0&&(T[w]=g[w]);return{$$typeof:e,type:m,key:C,ref:j,props:T,_owner:o.current}}return ka.Fragment=t,ka.jsx=h,ka.jsxs=h,ka}var Xm;function _w(){return Xm||(Xm=1,Zh.exports=yw()),Zh.exports}var Z=_w();const vw=()=>{};var Jm={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bt="WebChannelConnection";class w1 extends v1{constructor(e){super(e),this.u_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}jo(e,t,s,o,l){const h=bd();return new Promise(((m,g)=>{const _=new D_;_.setWithCredentials(!0),_.listenOnce(V_.COMPLETE,(()=>{try{switch(_.getLastErrorCode()){case bu.NO_ERROR:const T=_.getResponseJson();ne(bt,`XHR for RPC '${e}' ${h} received:`,JSON.stringify(T)),m(T);break;case bu.TIMEOUT:ne(bt,`RPC '${e}' ${h} timed out`),g(new ee(z.DEADLINE_EXCEEDED,"Request time out"));break;case bu.HTTP_ERROR:const C=_.getStatus();if(ne(bt,`RPC '${e}' ${h} failed with status:`,C,"response text:",_.getResponseText()),C>0){let j=_.getResponseJson();Array.isArray(j)&&(j=j[0]);const G=j==null?void 0:j.error;if(G&&G.status&&G.message){const K=(function(he){const ce=he.toLowerCase().replace(/_/g,"-");return Object.values(z).indexOf(ce)>=0?ce:z.UNKNOWN})(G.status);g(new ee(K,G.message))}else g(new ee(z.UNKNOWN,"Server responded with status "+_.getStatus()))}else g(new ee(z.UNAVAILABLE,"Connection failed."));break;default:ye(9055,{c_:e,streamId:h,l_:_.getLastErrorCode(),h_:_.getLastError()})}}finally{ne(bt,`RPC '${e}' ${h} completed.`)}}));const w=JSON.stringify(o);ne(bt,`RPC '${e}' ${h} sending request:`,o),_.send(t,"POST",w,s,15)}))}P_(e,t,s){const o=bd(),l=[this.$o,"/","google.firestore.v1.Firestore","/",e,"/channel"],h=L_(),m=x_(),g={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},_=this.longPollingOptions.timeoutSeconds;_!==void 0&&(g.longPollingTimeout=Math.round(1e3*_)),this.useFetchStreams&&(g.useFetchStreams=!0),this.zo(g.initMessageHeaders,t,s),g.encodeInitMessageHeaders=!0;const w=l.join("");ne(bt,`Creating RPC '${e}' stream ${o}: ${w}`,g);const T=h.createWebChannel(w,g);this.T_(T);let C=!1,j=!1;const G=new E1({Ho:B=>{j?ne(bt,`Not sending because RPC '${e}' stream ${o} is closed:`,B):(C||(ne(bt,`Opening RPC '${e}' stream ${o} transport.`),T.open(),C=!0),ne(bt,`RPC '${e}' stream ${o} sending:`,B),T.send(B))},Yo:()=>T.close()}),K=(B,he,ce)=>{B.listen(he,(me=>{try{ce(me)}catch(we){setTimeout((()=>{throw we}),0)}}))};return K(T,Va.EventType.OPEN,(()=>{j||(ne(bt,`RPC '${e}' stream ${o} transport opened.`),G.s_())})),K(T,Va.EventType.CLOSE,(()=>{j||(j=!0,ne(bt,`RPC '${e}' stream ${o} transport closed`),G.__(),this.I_(T))})),K(T,Va.EventType.ERROR,(B=>{j||(j=!0,_i(bt,`RPC '${e}' stream ${o} transport errored. Name:`,B.name,"Message:",B.message),G.__(new ee(z.UNAVAILABLE,"The operation could not be completed")))})),K(T,Va.EventType.MESSAGE,(B=>{var he;if(!j){const ce=B.data[0];be(!!ce,16349);const me=ce,we=(me==null?void 0:me.error)||((he=me[0])===null||he===void 0?void 0:he.error);if(we){ne(bt,`RPC '${e}' stream ${o} received error:`,we);const je=we.status;let Te=(function(R){const k=lt[R];if(k!==void 0)return yv(k)})(je),D=we.message;Te===void 0&&(Te=z.INTERNAL,D="Unknown error status: "+je+" with message "+we.message),j=!0,G.__(new ee(Te,D)),T.close()}else ne(bt,`RPC '${e}' stream ${o} received:`,ce),G.a_(ce)}})),K(m,O_.STAT_EVENT,(B=>{B.stat===Sd.PROXY?ne(bt,`RPC '${e}' stream ${o} detected buffering proxy`):B.stat===Sd.NOPROXY&&ne(bt,`RPC '${e}' stream ${o} detected no buffering proxy`)})),setTimeout((()=>{G.o_()}),0),G}terminate(){this.u_.forEach((e=>e.close())),this.u_=[]}T_(e){this.u_.push(e)}I_(e){this.u_=this.u_.filter((t=>t===e))}}function cd(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ny;function VR(){return Ny||(Ny=1,(function(i){function e(J,de){var re=J.length;J.push(de);e:for(;0<re;){var O=re-1>>>1,q=J[O];if(0<o(q,de))J[O]=de,J[re]=q,re=O;else break e}}function t(J){return J.length===0?null:J[0]}function s(J){if(J.length===0)return null;var de=J[0],re=J.pop();if(re!==de){J[0]=re;e:for(var O=0,q=J.length,le=q>>>1;O<le;){var Ie=2*(O+1)-1,Ae=J[Ie],Ne=Ie+1,Le=J[Ne];if(0>o(Ae,re))Ne<q&&0>o(Le,Ae)?(J[O]=Le,J[Ne]=re,O=Ne):(J[O]=Ae,J[Ie]=re,O=Ie);else if(Ne<q&&0>o(Le,re))J[O]=Le,J[Ne]=re,O=Ne;else break e}}return de}function o(J,de){var re=J.sortIndex-de.sortIndex;return re!==0?re:J.id-de.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;i.unstable_now=function(){return l.now()}}else{var h=Date,m=h.now();i.unstable_now=function(){return h.now()-m}}var g=[],_=[],w=1,T=null,C=3,j=!1,G=!1,K=!1,B=typeof setTimeout=="function"?setTimeout:null,he=typeof clearTimeout=="function"?clearTimeout:null,ce=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function me(J){for(var de=t(_);de!==null;){if(de.callback===null)s(_);else if(de.startTime<=J)s(_),de.sortIndex=de.expirationTime,e(g,de);else break;de=t(_)}}function we(J){if(K=!1,me(J),!G)if(t(g)!==null)G=!0,Vt(je);else{var de=t(_);de!==null&&Ue(we,de.startTime-J)}}function je(J,de){G=!1,K&&(K=!1,he(S),S=-1),j=!0;var re=C;try{for(me(de),T=t(g);T!==null&&(!(T.expirationTime>de)||J&&!V());){var O=T.callback;if(typeof O=="function"){T.callback=null,C=T.priorityLevel;var q=O(T.expirationTime<=de);de=i.unstable_now(),typeof q=="function"?T.callback=q:T===t(g)&&s(g),me(de)}else s(g);T=t(g)}if(T!==null)var le=!0;else{var Ie=t(_);Ie!==null&&Ue(we,Ie.startTime-de),le=!1}return le}finally{T=null,C=re,j=!1}}var Te=!1,D=null,S=-1,R=5,k=-1;function V(){return!(i.unstable_now()-k<R)}function x(){if(D!==null){var J=i.unstable_now();k=J;var de=!0;try{de=D(!0,J)}finally{de?A():(Te=!1,D=null)}}else Te=!1}var A;if(typeof ce=="function")A=function(){ce(x)};else if(typeof MessageChannel<"u"){var tt=new MessageChannel,Dt=tt.port2;tt.port1.onmessage=x,A=function(){Dt.postMessage(null)}}else A=function(){B(x,0)};function Vt(J){D=J,Te||(Te=!0,A())}function Ue(J,de){S=B(function(){J(i.unstable_now())},de)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(J){J.callback=null},i.unstable_continueExecution=function(){G||j||(G=!0,Vt(je))},i.unstable_forceFrameRate=function(J){0>J||125<J?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<J?Math.floor(1e3/J):5},i.unstable_getCurrentPriorityLevel=function(){return C},i.unstable_getFirstCallbackNode=function(){return t(g)},i.unstable_next=function(J){switch(C){case 1:case 2:case 3:var de=3;break;default:de=C}var re=C;C=de;try{return J()}finally{C=re}},i.unstable_pauseExecution=function(){},i.unstable_requestPaint=function(){},i.unstable_runWithPriority=function(J,de){switch(J){case 1:case 2:case 3:case 4:case 5:break;default:J=3}var re=C;C=J;try{return de()}finally{C=re}},i.unstable_scheduleCallback=function(J,de,re){var O=i.unstable_now();switch(typeof re=="object"&&re!==null?(re=re.delay,re=typeof re=="number"&&0<re?O+re:O):re=O,J){case 1:var q=-1;break;case 2:q=250;break;case 5:q=1073741823;break;case 4:q=1e4;break;default:q=5e3}return q=re+q,J={id:w++,callback:de,priorityLevel:J,startTime:re,expirationTime:q,sortIndex:-1},re>O?(J.sortIndex=re,e(_,J),t(g)===null&&J===t(_)&&(K?(he(S),S=-1):K=!0,Ue(we,re-O))):(J.sortIndex=q,e(g,J),G||j||(G=!0,Vt(je))),J},i.unstable_shouldYield=V,i.unstable_wrapCallback=function(J){var de=C;return function(){var re=C;C=de;try{return J.apply(this,arguments)}finally{C=re}}}})(pd)),pd}var Dy;function OR(){return Dy||(Dy=1,fd.exports=VR()),fd.exports}/**
 * @license React
