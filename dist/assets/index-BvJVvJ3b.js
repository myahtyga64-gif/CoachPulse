 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Vm;function jE(){if(Vm)return wa;Vm=1;var i=Dd(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),s=Object.prototype.hasOwnProperty,o=i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,u={key:!0,ref:!0,__self:!0,__source:!0};function h(m,g,v){var w,C={},N=null,j=null;v!==void 0&&(N=""+v),g.key!==void 0&&(N=""+g.key),g.ref!==void 0&&(j=g.ref);for(w in g)s.call(g,w)&&!u.hasOwnProperty(w)&&(C[w]=g[w]);if(m&&m.defaultProps)for(w in g=m.defaultProps,g)C[w]===void 0&&(C[w]=g[w]);return{$$typeof:e,type:m,key:N,ref:j,props:C,_owner:o.current}}return wa.Fragment=t,wa.jsx=h,wa.jsxs=h,wa}var Om;function zE(){return Om||(Om=1,Hh.exports=jE()),Hh.exports}var Z=zE(),Zt=Dd();const BE=FE(Zt);var vu={},qh={exports:{}},Yt={},Kh={exports:{}},Gh={};/**
 * @license React
...
</defs>`,G.innerText="Preview backend running in this workspace."),G.setAttribute("id",j)}document.readyState==="loading"?window.addEventListener("DOMContentLoaded",C):C()}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function RT(i){switch(i){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function CT(i){const e=Ta(Ia(i)).link,t=e?Ta(Ia(e)).deep_link_id:null,s=Ta(Ia(i)).deep_link_id;return(s?Ta(Ia(s)).link:null)||s||t||e||i}class zd{constructor(e){var t,s,o,u,h,m;const g=Ta(Ia(e)),v=(t=g.apiKey)!==null&&t!==void 0?t:null,w=(s=g.oobCode)!==null&&s!==void 0?s:null,C=RT((o=g.mode)!==null&&o!==void 0?o:null);pe(v&&w&&C,"argument-error"),this.apiKey=v,this.operation=C,this.code=w,this.continueUrl=(u=g.continueUrl)!==null&&u!==void 0?u:null,this.languageCode=(h=g.lang)!==null&&h!==void 0?h:null,this.tenantId=(m=g.tenantId)!==null&&m!==void 0?m:null}static parseLink(e){const t=CT(e);try{return new zd(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xI="__/auth/handler",LI="emulator/auth/handler",MI=encodeURIComponent("fac");async function hg(i,e,t,s,o,u){pe(i.config.authDomain,i,"auth-domain-config-required"),pe(i.config.apiKey,i,"invalid-api-key");const h={apiKey:i.config.apiKey,appName:i.name,authType:t,redirectUrl:s,v:wo,eventId:o};if(e instanceof Wy){e.setDefaultLanguage(i.languageCode),h.providerId=e.providerId||"",ww(e.getCustomParameters())||(h.customParameters=JSON.stringify(e.getCustomParameters()));for(const[w,C]of Object.entries({}))h[w]=C}if(e instanceof Ya){const w=e.getScopes().filter(C=>C!=="");w.length>0&&(h.scopes=w.join(","))}i.tenantId&&(h.tid=i.tenantId);const m=h;for(const w of Object.keys(m))m[w]===void 0&&delete m[w];const g=await i._getAppCheckToken(),v=g?`#${MI}=${encodeURIComponent(g)}`:"";return`${bI(i)}?${Ga(m).slice(1)}${v}`}function bI({config:i}){return i.emulator?bd(i,LI):`https://${i.authDomain}/${xI}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Jt.DEFAULT_COLLECTION_PERCENTILE=10,Jt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,Jt.DEFAULT=new Jt(ev,Jt.DEFAULT_COLLECTION_PERCENTILE,Jt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),Jt.DISABLED=new Jt(-1,0,0);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class P1{constructor(e,t,s,o){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=s,this.indexManager=o}getDocument(e,t){let s=null;return this.documentOverlayCache.getOverlay(e,t).next((o=>(s=o,this.remoteDocumentCache.getEntry(e,t)))).next((o=>(s!==null&&Oa(s.mutation,o,bn.empty(),qe.now()),o)))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next((s=>this.getLocalViewOfDocuments(e,s,Pe()).next((()=>s))))}getLocalViewOfDocuments(e,t,s=Pe()){const o=Zi();return this.populateOverlays(e,o,t).next((()=>this.computeViews(e,t,o,s).next((u=>{let h=Aa();return u.forEach(((m,g)=>{h=h.insert(m,g.overlayedDocument)})),h}))))}getOverlayedDocuments(e,t){const s=Zi();return this.populateOverlays(e,s,t).next((()=>this.computeViews(e,t,s,Pe())))}populateOverlays(e,t,s){const o=[];return s.forEach((u=>{t.has(u)||o.push(u)})),this.documentOverlayCache.getOverlays(e,o).next((u=>{u.forEach(((h,m)=>{t.set(h,m)}))}))}computeViews(e,t,s,o){let u=Dr();const h=Va(),m=(function(){return Va()})();return t.forEach(((g,v)=>{const w=s.get(v.key);o.has(v.key)&&(w===void 0||w.mutation instanceof cs)?u=u.insert(v.key,v):w!==void 0?(h.set(v.key,w.mutation.getFieldMask()),Oa(w.mutation,v,w.mutation.getFieldMask(),qe.now())):h.set(v.key,bn.empty())})),this.recalculateAndSaveOverlays(e,u).next((g=>(g.forEach(((v,w)=>h.set(v,w))),t.forEach(((v,w)=>{var C;return m.set(v,new C1(w,(C=h.get(v))!==null&&C!==void 0?C:null))})),m)))}recalculateAndSaveOverlays(e,t){const s=Va();let o=new Ze(((h,m)=>h-m)),u=Pe();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next((h=>{for(const m of h)m.keys().forEach((g=>{const v=t.get(g);if(v===null)return;let w=s.get(g)||bn.empty();w=m.applyToLocalView(v,w),s.set(g,w);const C=(o.get(m.batchId)||Pe()).add(g);o=o.insert(m.batchId,C)}))})).next((()=>{const h=[],m=o.getReverseIterator();for(;m.hasNext();){const g=m.getNext(),v=g.key,w=g.value,C=L_();w.forEach((N=>{if(!u.has(N)){const j=z_(t.get(N),s.get(N));j!==null&&C.set(N,j),u=u.add(N)}})),h.push(this.documentOverlayCache.saveOverlays(e,v,C))}return z.waitFor(h)})).next((()=>s))}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next((s=>this.recalculateAndSaveOverlays(e,s)))}getDocumentsMatchingQuery(e,t,s,o){return(function(h){return de.isDocumentKey(h.path)&&h.collectionGroup===null&&h.filters.length===0})(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):NS(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,s,o):this.getDocumentsMatchingCollectionQuery(e,t,s,o)}getNextDocuments(e,t,s,o){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,s,o).next((u=>{const h=o-u.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,s.largestBatchId,o-u.size):z.resolve(Zi());let m=Ua,g=u;return h.next((v=>z.forEach(v,((w,C)=>(m<C.largestBatchId&&(m=C.largestBatchId),u.get(w)?z.resolve():this.remoteDocumentCache.getEntry(e,w).next((N=>{g=g.insert(w,N)}))))).next((()=>this.populateOverlays(e,v,u))).next((()=>this.computeViews(e,g,v,Pe()))).next((w=>({batchId:m,changes:x_(w)})))))}))}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new de(t)).next((s=>{let o=Aa();return s.isFoundDocument()&&(o=o.insert(s.key,s)),o}))}getDocumentsMatchingCollectionGroupQuery(e,t,s,o){const u=t.collectionGroup;let h=Aa();return this.indexManager.getCollectionParents(e,u).next((m=>z.forEach(m,(g=>{const v=(function(C,N){return new uc(N,null,C.explicitOrderBy.slice(),C.filters.slice(),C.limit,C.limitType,C.startAt,C.endAt)})(t,g.child(u));return this.getDocumentsMatchingCollectionQuery(e,v,s,o).next((w=>{w.forEach(((C,N)=>{h=h.insert(C,N)}))}))})).next((()=>h))))}getDocumentsMatchingCollectionQuery(e,t,s,o){let u;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,s.largestBatchId).next((h=>(u=h,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,s,u,o)))).next((h=>{u.forEach(((g,v)=>{const w=v.getKey();h.get(w)===null&&(h=h.insert(w,Ft.newInvalidDocument(w)))}));let m=Aa();return h.forEach(((g,v)=>{const w=u.get(g);w!==void 0&&Oa(w.mutation,v,bn.empty(),qe.now()),hc(t,v)&&(m=m.insert(g,v))})),m}))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uR(i){i=Fa(i,Tt);const e=Fa(i.firestore,vf);return KA(Sv(e),i._key).then((t=>fR(e,i,t)))}xa._jsonSchemaVersion="firestore/querySnapshot/1.0",xa._jsonSchema={type:lt("string",xa._jsonSchemaVersion),bundleSource:lt("string","QuerySnapshot"),bundleName:lt("string"),bundle:lt("string")};class cR extends oR{constructor(e){super(),this.firestore=e}convertBytes(e){return new En(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Tt(this.firestore,null,t)}}function hR(i,e,t){i=Fa(i,Tt);const s=Fa(i.firestore,vf),o=aR(i.converter,e);return dR(s,[tR(eR(s),"setDoc",i._key,o,i.converter!==null,t).toMutation(i._key,Cr.none())])}function dR(i,e){return(function(s,o){const u=new pi;return s.asyncQueue.enqueueAndForget((async()=>OA(await WA(s),o,u))),u.promise})(Sv(i),e)}function fR(i,e,t){const s=t.docs.get(e._key),o=new cR(i);return new es(i,o,e._key,s,new Ca(t.hasPendingWrites,t.fromCache),e.converter)}function pR(){return new If("serverTimestamp")}(function(e,t=!0){(function(o){Io=o})(wo),po(new ns("firestore",((s,{instanceIdentifier:o,options:u})=>{const h=s.getProvider("app").getImmediate(),m=new vf(new XI(s.getProvider("auth-internal")),new ZI(h,s.getProvider("app-check-internal")),(function(v,w){if(!Object.prototype.hasOwnProperty.apply(v.options,["projectId"]))throw new ae(q.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new za(v.options.projectId,w)})(h,o),h);return u=Object.assign({useFetchStreams:t},u),m._setSettings(u),m}),"PUBLIC").setMultipleInstances(!0)),di(gg,yg,e),di(gg,yg,"esm2017")})();const mR={apiKey:"AIzaSyCjLVUF_wyjlduSuCi_4DEyKXOt8JjEvsQ",authDomain:"coachpulse-87341.firebaseapp.com",projectId:"coachpulse-87341",storageBucket:"coachpulse-87341.firebasestorage.app",messagingSenderId:"440637829553",appId:"1:440637829553:web:96fdc2e49e5e58fed18d90"},Ov=wy(mR),tc=qI(Ov),xv=QA(Ov);function gR({onSubmit:i}){const[e,t]=Zt.useState("");async function s(o){t(o);try{console.log("🔥 Click:",o);const u=tc.currentUser;if(!u){console.log("❌ NO USER LOGGED IN");return}const h=new Date().toISOString().split("T")[0],m=Iv(xv,"users",u.uid,"workouts",h);await hR(m,{status:o,date:h,createdAt:pR()}),console.log("✅ SAVED REAL WORKOUT TO FIRESTORE"),i&&i(o)}catch(u){console.error("❌ Firestore error:",u)}}return Z.jsxs("section",{className:"panel",children:[Z.jsx("h2",{children:"Today's workout"}),Z.jsxs("div",{className:"button-row",children:[Z.jsx("button",{onClick:()=>s("completed"),children:"Completed"}),Z.jsx("button",{onClick:()=>s("partial"),children:"Partly done"}),Z.jsx("button",{onClick:()=>s("missed"),children:"Missed"})]})]})}function yR(i,e,t){const s=i.toLowerCase();return s.includes("miss")||s.includes("tired")||s.includes("busy")?`No shame. Keep it small: do 10 minutes today. Your current streak is ${e}, and consistency matters more than perfection.`:s.includes("completed")||s.includes("done")?`Great job. That is ${t} workout(s) logged. Lock in the habit and make tomorrow easy.`:"I’m with you. Choose the smallest workout you can do today and start now. Even 10 minutes counts."}function _R({streak:i,completedWorkouts:e}){const[t,s]=Zt.useState([{role:"assistant",text:"Tell me how today went. Completed, missed, or struggling?"}]),[o,u]=Zt.useState("");function h(){if(!o.trim())return;const m={role:"user",text:o.trim()},g={role:"assistant",text:yR(o,i,e)};s(v=>[...v,m,g]),u("")}return Z.jsxs("section",{className:"panel",children:[Z.jsx("h2",{children:"AI Coach"}),Z.jsx("p",{className:"muted",children:"Demo mode uses local replies. Connect Firebase Functions + OpenAI next."}),Z.jsx("div",{className:"chat",children:t.map((m,g)=>Z.jsx("div",{className:`bubble ${m.role}`,children:m.text},g))}),Z.jsxs("div",{className:"chat-input",children:[Z.jsx("input",{value:o,placeholder:"Message your coach...",onChange:m=>u(m.target.value),onKeyDown:m=>m.key==="Enter"&&h()}),Z.jsx("button",{onClick:h,children:"Send"})]})]})}function vR({user:i,onLogout:e}){const[t,s]=Zt.useState(0),[o,u]=Zt.useState(0),[h,m]=Zt.useState(null);function g(v){v==="completed"&&(u(w=>w+1),s(w=>w+1))}return Zt.useEffect(()=>{(async()=>{const w=tc.currentUser;if(!w)return;const C=new Date().toISOString().split("T")[0],N=Iv(xv,"users",w.uid,"workouts",C),j=await uR(N);j.exists()?m(j.data()):m(null)})()},[]),Z.jsxs("main",{className:"page",children:[Z.jsxs("header",{className:"topbar",children:[Z.jsxs("div",{children:[Z.jsx("p",{className:"badge",children:"Beta MVP"}),Z.jsx("h1",{children:"Welcome back"}),Z.jsx("p",{children:i==null?void 0:i.email})]}),Z.jsx("button",{className:"ghost",onClick:e,children:"Log out"})]}),h?Z.jsxs("div",{children:[Z.jsx("h3",{children:"Today's Status:"}),Z.jsx("p",{children:h.status})]}):Z.jsx("div",{children:Z.jsx("h3",{children:"No workout logged today"})}),Z.jsxs("section",{className:"stats",children:[Z.jsxs("div",{className:"stat",children:[Z.jsx("span",{children:"🔥"}),Z.jsx("h2",{children:t}),Z.jsx("p",{children:"Day streak"})]}),Z.jsxs("div",{className:"stat",children:[Z.jsx("span",{children:"💪"}),Z.jsx("h2",{children:o}),Z.jsx("p",{children:"Workouts done"})]}),Z.jsxs("div",{className:"stat",children:[Z.jsx("span",{children:"🎯"}),Z.jsx("h2",{children:"Get Fit"}),Z.jsx("p",{children:"Current goal"})]})]}),Z.jsxs("section",{className:"layout",children:[Z.jsx(gR,{onSubmit:g}),Z.jsx(_R,{streak:t,completedWorkouts:o})]})]})}function ER({onLogin:i}){const[e,t]=Zt.useState(""),[s,o]=Zt.useState(""),[u,h]=Zt.useState(!0),[m,g]=Zt.useState("");async function v(){g("");try{let w;u?w=await OT(tc,e,s):w=await VT(tc,e,s),i(w.user.email)}catch(w){g(w.message)}}return Z.jsx("main",{className:"page narrow",children:Z.jsxs("section",{className:"panel",children:[Z.jsx("h1",{children:u?"Login":"Create Account"}),Z.jsx("input",{type:"email",placeholder:"Email",value:e,onChange:w=>t(w.target.value)}),Z.jsx("input",{type:"password",placeholder:"Password",value:s,onChange:w=>o(w.target.value)}),m&&Z.jsx("p",{style:{color:"red"},children:m}),Z.jsx("button",{className:"primary full",onClick:v,children:u?"Login":"Sign Up"}),Z.jsx("p",{style:{cursor:"pointer",marginTop:10},onClick:()=>h(!u),children:u?"Don't have an account? Sign up":"Already have an account? Login"})]})})}function wR(){const[i,e]=Zt.useState("landing"),[t,s]=Zt.useState(null);return i==="login"?Z.jsx(ER,{onLogin:o=>{s({email:o}),e("dashboard")}}):i==="dashboard"?Z.jsx(vR,{user:t,onLogout:()=>{s(null),e("landing")}}):Z.jsx(QE,{onStart:()=>e("login")})}GE.createRoot(document.getElementById("root")).render(Z.jsx(BE.StrictMode,{children:Z.jsx(wR,{})}));
