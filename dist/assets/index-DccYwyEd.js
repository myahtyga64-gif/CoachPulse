...
*/var Si,Dv;(function(){var r;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(P,I){function R(){}R.prototype=I.prototype,P.D=I.prototype,P.prototype=new R,P.prototype.constructor=P,P.C=function(N,O,b){for(var k=Array(arguments.length-2),st=2;st<arguments.length;st++)k[st-2]=arguments[st];return I.prototype[O].apply(N,k)}}function t(){this.blockSize=-1}function i(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(i,t),i.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function o(P,I,R){R||(R=0);var N=Array(16);if(typeof I=="string")for(var O=0;16>O;++O)N[O]=I.charCodeAt(R++)|I.charCodeAt(R++)<<8|I.charCodeAt(R++)<<16|I.charCodeAt(R++)<<24;else for(O=0;16>O;++O)N[O]=I[R++]|I[R++]<<8|I[R++]<<16|I[R++]<<24;I=P.g[0],R=P.g[1],O=P.g[2];var b=P.g[3],k=I+(b^R&(O^b))+N[0]+3614090360&4294967295;I=R+(k<<7&4294967295|k>>>25),k=b+(O^I&(R^O))+N[1]+3905402710&4294967295,b=I+(k<<12&4294967295|k>>>20),k=O+(R^b&(I^R))+N[2]+606105819&4294967295,O=b+(k<<17&4294967295|k>>>15),k=R+(I^O&(b^I))+N[3]+3250441966&4294967295,R=O+(k<<22&4294967295|k>>>10),k=I+(b^R&(O^b))+N[4]+4118548399&4294967295,I=R+(k<<7&4294967295|k>>>25),k=b+(O^I&(R^O))+N[5]+1200080426&4294967295,b=I+(k<<12&4294967295|k>>>20),k=O+(R^b&(I^R))+N[6]+2821735955&4294967295,O=b+(k<<17&4294967295|k>>>15),k=R+(I^O&(b^I))+N[7]+4249261313&4294967295,R=O+(k<<22&4294967295|k>>>10),k=I+(b^R&(O^b))+N[8]+1770035416&4294967295,I=R+(k<<7&4294967295|k>>>25),k=b+(O^I&(R^O))+N[9]+2336552879&4294967295,b=I+(k<<12&4294967295|k>>>20),k=O+(R^b&(I^R))+N[10]+4294925233&4294967295,O=b+(k<<17&4294967295|k>>>15),k=R+(I^O&(b^I))+N[11]+2304563134&4294967295,R=O+(k<<22&4294967295|k>>>10),k=I+(b^R&(O^b))+N[12]+1804603682&4294967295,I=R+(k<<7&4294967295|k>>>25),k=b+(O^I&(R^O))+N[13]+4254626195&4294967295,b=I+(k<<12&4294967295|k>>>20),k=O+(R^b&(I^R))+N[14]+2792965006&4294967295,O=b+(k<<17&4294967295|k>>>15),k=R+(I^O&(b^I))+N[15]+1236535329&4294967295,R=O+(k<<22&4294967295|k>>>10),k=I+(O^b&(R^O))+N[1]+4129170786&4294967295,I=R+(k<<5&4294967295|k>>>27),k=b+(R^O&(I^R))+N[6]+3225465664&4294967295,b=I+(k<<9&4294967295|k>>>23),k=O+(I^R&(b^I))+N[11]+643717713&4294967295,O=b+(k<<14&4294967295|k>>>18),k=R+(b^I&(O^b))+N[0]+3921069994&4294967295,R=O+(k<<20&4294967295|k>>>12),k=I+(O^b&(R^O))+N[5]+3593408605&4294967295,I=R+(k<<5&4294967295|k>>>27),k=b+(R^O&(I^R))+N[10]+38016083&4294967295,b=I+(k<<9&4294967295|k>>>23),k=O+(I^R&(b^I))+N[15]+3634488961&4294967295,O=b+(k<<14&4294967295|k>>>18),k=R+(b^I&(O^b))+N[4]+3889429448&4294967295,R=O+(k<<20&4294967295|k>>>12),k=I+(O^b&(R^O))+N[9]+568446438&4294967295,I=R+(k<<5&4294967295|k>>>27),k=b+(R^O&(I^R))+N[14]+3275163606&4294967295,b=I+(k<<9&4294967295|k>>>23),k=O+(I^R&(b^I))+N[3]+4107603335&4294967295,O=b+(k<<14&4294967295|k>>
>>22),k=O+(I^(b|~R))+N[2]+718787259&4294967295,O=b+(k<<15&4294967295|k>>>17),k=R+(b^(O|~I))+N[9]+3951481745&4294967295,P.g[0]=P.g[0]+I&4294967295,P.g[1]=P.g[1]+(O+(k<<21&4294967295|k>>>11))&4294967295,P.g[2]=P.g[2]+O&4294967295,P.g[3]=P.g[3]+b&4294967295}i.prototype.u=function(P,I){I===void 0&&(I=P.length);for(var R=I-this.blockSize,N=this.B,O=this.h,b=0;b<I;){if(O==0)for(;b<=R;)o(this,P,b),b+=this.blockSize;if(typeof P=="string"){for(;b<I;)if(N[O++]=P.charCodeAt(b++),O==this.blockSize){o(this,N),O=0;break}}else for(;b<I;)if(N[O++]=P[b++],O==this.blockSize){o(this,N),O=0;break}}this.h=O,this.o+=I},i.prototype.v=function(){var P=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);P[0]=128;for(var I=1;I<P.length-8;++I)P[I]=0;var R=8*this.o;for(I=P.length-8;I<P.length;++I)P[I]=R&255,R/=256;for(this.u(P),P=Array(16),I=R=0;4>I;++I)for(var N=0;32>N;N+=8)P[R++]=this.g[I]>>>N&255;return P};function l(P,I){var R=f;return Object.prototype.hasOwnProperty.call(R,P)?R[P]:R[P]=I(P)}function h(P,I){this.h=I;for(var R=[],N=!0,O=P.length-1;0<=O;O--){var b=P[O]|0;N&&b==I||(R[O]=b,N=!1)}this.g=R}var f={};function g(P){return-128<=P&&128>P?l(P,function(I){return new h([I|0],0>I?-1:0)}):new h([P|0],0>P?-1:0)}function _(P){if(isNaN(P)||!isFinite(P))return T;if(0>P)return z(_(-P));for(var I=[],R=1,N=0;P>=R;N++)I[N]=P/R|0,R*=4294967296;return new h(I,0)}function w(P,I){if(P.length==0)throw Error("number format error: empty string");if(I=I||10,2>I||36<I)throw Error("radix out of range: "+I);if(P.charAt(0)=="-")return z(w(P.substring(1),I));if(0<=P.indexOf("-"))throw Error('number format error: interior "-" character');for(var R=_(Math.pow(I,8)),N=T,O=0;O<P.length;O+=8){var b=Math.min(8,P.length-O),k=parseInt(P.substring(O,O+b),I);8>b?(b=_(Math.pow(I,b)),N=N.j(b).add(_(k))):(N=N.j(R),N=N.add(_(k)))}return N}var T=g(0),S=g(1),V=g(16777216);r=h.prototype,r.m=function(){if(H(this))return-z(this).m();for(var P=0,I=1,R=0;R<this.g.length;R++){var N=this.i(R);P+=(0<=N?N:4294967296+N)*I,I*=4294967296}return P},r.toString=function(P){if(P=P||10,2>P||36<P)throw Error("radix out of range: "+P);if($(this))return"0";if(H(this))return"-"+z(this).toString(P);for(var I=_(Math.pow(P,6)),R=this,N="";;){var O=le(R,I).g;R=Y(R,O.j(I));var b=((0<R.g.length?R.g[0]:R.h)>>>0).toString(P);if(R=O,$(R))return b+N;for(;6>b.length;)b="0"+b;N=b+N}},r.i=function(P){return 0>P?0:P<this.g.length?this.g[P]:this.h};function $(P){if(P.h!=0)return!1;for(var I=0;I<P.g.length;I++)if(P.g[I]!=0)return!1;return!0}function H(P){return P.h==-1}r.l=function(P){return P=Y(this,P),H(P)?-1:$(P)?0:1};function z(P){for(var I=P.g.length,R=[],N=0;N<I;N++)R[N]=~P.g[N];return new h(R,~P.h).add(S)}r.abs=function(){return H(this)?z(this):this},r.add=function(P){for(var I=Math.max(this.g.length,P.g.length),R=[],N=0,O=0;O<=I;O++){var b=N+(this.i(O)&65535)+(P.i(O)&65535),k=(b>>>16)+(this.i(O)>>>16)+(P.i(O)>>>16);N=k>>>16,b&=65535,k&=65535,R[O]=k<<16|b}return new h(R,R[R.length-1]&-2147483648?-1:0)};function Y(P,I){return P.add(z(I))}r.j=function(P){if($(this)||$(P))return T;if(H(this))return H(P)?z(this).j(z(P)):z(z(this).j(P));if(H(P))return z(this.j(z(P)));if(0>this.l(V)&&0>P.l(V))return _(this.m()*P.m());for(var I=this.g.length+P.g.length,R=[],N=0;N<2*I;N++)R[N]=0;for(N=0;N<this.g.length;N++)for(var O=0;O<P.g.length;O++){var b=this.i(N)>>>16,k=this.i(N)&65535,st=P.i(O)>>>16,Lt=P.i(O)&65535;R[2*N+2*O]+=k*Lt,te(R,2*N+2*O),R[2*N+2*O+1]+=b*Lt,te(R,2*N+2*O+1),R[2*N+2*O+1]+=k*st,te(R,2*N+2*O+1),R[2*N+2*O+2]+=b*st,te(R,2*N+2*O+2)}for(N=0;N<I;N++)R[N]=R[2*N+1]<<16|R[2*N];for(N=I;N<2*I;N++)R[N]=0;return new h(R,0)};function te(P,I){for(;(P[I]&65535)!=P[I];)P[I+1]+=P[I]>>>16,P[I]&=65535,I++}function ne(P,I){this.g=P,this.h=I}function le(P,I){if($(I))throw Error("division by zero");if($(P))return new ne(T,T);if(H(P))return I=le(z(P),I),new ne(z(I.g),z(I.h));if(H(I))return I=le(P,z(I)),new ne(z(I.g),I.h);if(30<P.g.length){if(H(P)||H(I))throw Error("slowDivide_ only works with positive integers.");for(var R=S,N=I;0>=N.l(P);)R=Ce(R),N=Ce(N);var O=ve(R,1),b=ve(N,1);for(N=ve(N,2),R=ve(R,2);!$(N);){var k=b.add(N);0>=k.l(P)&&(O=O.add(R),b=k),N=ve(N,1),R=ve(R,1)}return I=Y(P,O.j(I)),new ne(O,I)}for(O=T;0<=P.l(I);){for(R=Math.max(1,Math.floor(P.m()/I.m())),N=Math.ceil(Math.log(R)/Math.LN2),N=48>=N?1:Math.pow(2,N-48),b=_(R),k=b.j(I);H(k)||0<k.l(P);)R-=N,b=_(R),k=b.j(I);$(b)&&(b=S),O=O.add(b),P=Y(P,k)}return new ne(O,P)}r.A=function(P){return le(this,P).h},r.and=function(P){for(var I=Math.max(this.g.length,P.g.length),R=[],N=0;N<I;N++)R[N]=this.i(N)&P.i(N);return new h(R,this.h&P.h)},r.or=function(P){for(var I=Math.max(this.g.length,P.g.length),R=[],N=0;N<I;N++)R[N]=this.i(N)|P.i(N);return new h(R,this.h|P.h)},r.xor=function(P){for(var I=Math.max(this.g.length,P.g.length),R=[],N=0;N<I;N++)R[N]=this.i(N)^P.i(N);return new h(R,this.h^P.h)};function Ce(P){for(var I=P.g.length+1,R=[],N=0;N<I;N++)R[N]=P.i(N)<<1|P.i(N-1)>>>31;return new h(R,P.h)}function ve(P,I){var R=I>>5;I%=32;for(var N=P.g.length-R,O=[],b=0;b<N;b++)O[b]=0<I?P.i(b+R)>>>I|P.i(b+R+1)<<32-I:P.i(b+R);return new h(O,P.h)}i.prototype.digest=i.prototype.v,i.prototype.reset=i.prototype.s,i.prototype.update=i.prototype.u,Dv=i,h.prototype.add=h.prototype.add,h.prototype.multiply=h.prototype.j,h.prototype.modulo=h.prototype.A,h.prototype.compare=h.prototype.l,h.prototype.toNumber=h.prototype.m,h.prototype.toString=h.prototype.toString,h.prototype.getBits=h.prototype.i,h.fromNumber=_,h.fromString=w,Si=h}).apply(typeof _y<"u"?_y:typeof self<"u"?self:typeof window<"u"?window:{});var $u=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
