 ...
 */var Xm;function vw(){if(Xm)return Re;Xm=1;var r=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),l=Symbol.for("react.provider"),h=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),g=Symbol.for("react.suspense"),_=Symbol.for("react.memo"),w=Symbol.for("react.lazy"),T=Symbol.iterator;function A(x){return x===null||typeof x!="object"?null:(x=T&&x[T]||x["@@iterator"],typeof x=="function"?x:null)}var U={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},q=Object.assign,K={};function $(x,H,ce){this.props=x,this.context=H,this.refs=K,this.updater=ce||U}$.prototype.isReactComponent={},$.prototype.setState=function(x,H){if(typeof x!="object"&&typeof x!="function"&&x!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,x,H,"setState")},$.prototype.forceUpdate=function(x){this.updater.enqueueForceUpdate(this,x,"forceUpdate")};function de(){}de.prototype=$.prototype;function ae(x,H,ce){this.props=x,this.context=H,this.refs=K,this.updater=ce||U}var ue=ae.prototype=new de;ue.constructor=ae,q(ue,$.prototype),ue.isPureReactComponent=!0;var ve=Array.isArray,Ue=Object.prototype.hasOwnProperty,Te={current:null},D={key:!0,ref:!0,__self:!0,__source:!0};function S(x,H,ce){var Ie,Ae={},Ne=null,Le=null;if(H!=null)for(Ie in H.ref!==void 0&&(Le=H.ref),H.key!==void 0&&(Ne=""+H.key),H)Ue.call(H,Ie)&&!D.hasOwnProperty(Ie)&&(Ae[Ie]=H[Ie]);var Me=arguments.length-2;if(Me===1)Ae.children=ce;else if(1<Me){for(var $e=Array(Me),_t=0;_t<Me;_t++)$e[_t]=arguments[_t+2];Ae.children=$e}if(x&&x.defaultProps)for(Ie in Me=x.defaultProps,Me)Ae[Ie]===void 0&&(Ae[Ie]=Me[Ie]);return{$$typeof:r,type:x,key:Ne,ref:Le,props:Ae,_owner:Te.current}}function C(x,H){return{$$typeof:r,type:x.type,key:H,ref:x.ref,props:x.props,_owner:x._owner}}function k(x){return typeof x=="object"&&x!==null&&x.$$typeof===r}function V(x){var H={"=":"=0",":":"=2"};return"$"+x.replace(/[=:]/g,function(ce){return H[ce]})}var O=/\/+/g;function R(x,H){return typeof x=="object"&&x!==null&&x.key!=null?V(""+x.key):H.toString(36)}function nt(x,H,ce,Ie,Ae){var Ne=typeof x;(Ne==="undefined"||Ne==="boolean")&&(x=null);var Le=!1;if(x===null)Le=!0;else switch(Ne){case"string":case"number":Le=!0;break;case"object":switch(x.$$typeof){case r:case e:Le=!0}}if(Le)return Le=x,Ae=Ae(Le),x=Ie===""?"."+R(Le,0):Ie,ve(Ae)?(ce="",x!=null&&(ce=x.replace(O,"$&/")+"/"),nt(Ae,H,ce,"",function(_t){return _t})):Ae!=null&&(k(Ae)&&(Ae=C(Ae,ce+(!Ae.key||Le&&Le.key===Ae.key?"":(""+Ae.key).replace(O,"$&/")+"/")+x)),H.push(Ae)),1;if(Le=0,Ie=Ie===""?".":Ie+":",ve(x))for(var Me=0;Me<x.length;Me++){Ne=x[Me];var $e=Ie+R(Ne,Me);Le+=nt(Ne,H,ce,$e,Ae)}else if($e=A(x),typeof $e=="function")for(x=$e.call(x),Me=0;!(Ne=x.next()).done;)Ne=Ne.value,$e=Ie+R(Ne,Me++),Le+=nt(Ne,H,ce,$e,Ae);else if(Ne==="object")throw H=String(x),Error("Objects are not valid as a React child (found: "+(H==="[object Object]"?"object with keys {"+Object.keys(x).join(", ")+"}":H)+"). If you meant to render a collection of children, use an array instead.");return Le}function Dt(x,H,ce){if(x==null)return x;var Ie=[],Ae=0;return nt(x,Ie,"","",function(Ne){return H.call(ce,Ne,Ae++)}),Ie}function Vt(x){if(x._status===-1){var H=x._result;H=H(),H.then(function(ce){(x._status===0||x._status===-1)&&(x._status=1,x._result=ce)},function(ce){(x._status===0||x._status===-1)&&(x._status=2,x._result=ce)}),x._status===-1&&(x._status=0,x._result=H)}if(x._status===1)return x._result.default;throw x._result}var ze={current:null},Z={transition:null},fe={ReactCurrentDispatcher:ze,ReactCurrentBatchConfig:Z,ReactCurrentOwner:Te};function re(){throw Error("act(...) is not supported in production builds of React.")}return Re.Children={map:Dt,forEach:function(x,H,ce){Dt(x,function(){H.apply(this,arguments)},ce)},count:function(x){var H=0;return Dt(x,function(){H++}),H},toArray:function(x){return Dt(x,function(H){return H})||[]},only:function(x){if(!k(x))throw Error("React.Children.only expected to receive a single React element child.");return x}},Re.Component=$,Re.Fragment=t,Re.Profiler=o,Re.PureComponent=ae,Re.StrictMode=s,Re.Suspense=g,Re.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=fe,Re.act=re,Re.cloneElement=function(x,H,ce){if(x==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+x+".");var Ie=q({},x.props),Ae=x.key,Ne=x.ref,Le=x._owner;if(H!=null){if(H.ref!==void 0&&(Ne=H.ref,Le=Te.current),H.key!==void 0&&(Ae=""+H.key),x.type&&x.type.defaultProps)var Me=x.type.defaultProps;for($e in H)Ue.call(H,$e)&&!D.hasOwnProperty($e)&&(Ie[$e]=H[$e]===void 0&&Me!==void 0?Me[$e]:H[$e])}var $e=arguments.length-2;if($e===1)Ie.children=ce;else if(1<$e){Me=Array($e);for(var _t=0;_t<$e;_t++)Me[_t]=arguments[_t+2];Ie.children=Me}return{$$typeof:r,type:x.type,key:Ae,ref:Ne,props:Ie,_owner:Le}},Re.createContext=function(x){return x={$$typeof:h,_currentValue:x,_currentValue2:x,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},x.Provider={$$typeof:l,_context:x},x.Consumer=x},Re.createElement=S,Re.createFactory=function(x){var H=S.bind(null,x);return H.type=x,H},Re.createRef=function(){return{current:null}},Re.forwardRef=function(x){return{$$typeof:m,render:x}},Re.isValidElement=k,Re.lazy=function(x){return{$$typeof:w,_payload:{_status:-1,_result:x},_init:Vt}},Re.memo=function(x,H){return{$$typeof:_,type:x,compare:H===void 0?null:H}},Re.startTransition=function(x){var H=Z.transition;Z.transition={};try{x()}finally{Z.transition=H}},Re.unstable_act=re,Re.useCallback=function(x,H){return ze.current.useCallback(x,H)},Re.useContext=function(x){return ze.current.useContext(x)},Re.useDebugValue=function(){},Re.useDeferredValue=function(x){return ze.current.useDeferredValue(x)},Re.useEffect=function(x,H){return ze.current.useEffect(x,H)},Re.useId=function(){return ze.current.useId()},Re.useImperativeHandle=function(x,H,ce){return ze.current.useImperativeHandle(x,H,ce)},Re.useInsertionEffect=function(x,H){return ze.current.useInsertionEffect(x,H)},Re.useLayoutEffect=function(x,H){return ze.current.useLayoutEffect(x,H)},Re.useMemo=function(x,H){return ze.current.useMemo(x,H)},Re.useReducer=function(x,H,ce){return ze.current.useReducer(x,H,ce)},Re.useRef=function(x){return ze.current.useRef(x)},Re.useState=function(x){return ze.current.useState(x)},Re.useSyncExternalStore=function(x,H,ce){return ze.current.useSyncExternalStore(x,H,ce)},Re.useTransition=function(){return ze.current.useTransition()},Re.version="18.3.1",Re}var Jm;function Hd(){return Jm||(Jm=1,id.exports=vw()),id.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Zm;function Ew(){if(Zm)return Na;Zm=1;var r=Hd(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),s=Object.prototype.hasOwnProperty,o=r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,l={key:!0,ref:!0,__self:!0,__source:!0};function h(m,g,_){var w,T={},A=null,U=null;_!==void 0&&(A=""+_),g.key!==void 0&&(A=""+g.key),g.ref!==void 0&&(U=g.ref);for(w in g)s.call(g,w)&&!l.hasOwnProperty(w)&&(T[w]=g[w]);if(m&&m.defaultProps)for(w in g=m.defaultProps,g)T[w]===void 0&&(T[w]=g[w]);return{$$typeof:e,type:m,key:A,ref:U,props:T,_owner:o.current}}return Na.Fragment=t,Na.jsx=h,Na.jsxs=h,Na}var eg;function ww(){return eg||(eg=1,rd.exports=Ew()),rd.exports}var z=ww();const Tw=()=>{};var tg={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vw(r,e){if(r.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const t={alg:"none",type:"JWT"},s=e||"demo-project",o=r.iat||0,l=r.sub||r.user_id;if(!l)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const h=Object.assign({iss:`https://securetoken.google.com/${s}`,aud:s,iat:o,exp:o+3600,auth_time:o,sub:l,user_id:l,firebase:{sign_in_provider:"custom",identities:{}}},r);return[Hu(JSON.stringify(t)),Hu(JSON.stringify(h)),""].join(".")}const ba={};function xw(){const r={prod:[],emulator:[]};for(const e of Object.keys(ba))ba[e]?r.emulator.push(e):r.prod.push(e);return r}function Ow(r){let e=document.getElementById(r),t=!1;return e||(e=document.createElement("div"),e.setAttribute("id",r),t=!0),{created:t,element:e}}let ng=!1;function Wy(r,e){if(typeof window>"u"||typeof document>"u"||!Po(window.location.host)||ba[r]===e||ba[r]||ng)return;ba[r]=e;function t(A){return`__firebase__banner__${A}`}const s="__firebase__banner",l=xw().prod.length>0;function h(){const A=document.getElementById(s);A&&A.remove()}function m(A){A.style.display="flex",A.style.background="#7faaf0",A.style.position="fixed",A.style.bottom="5px",A.style.left="5px",A.style.padding=".5em",A.style.borderRadius="5px",A.style.alignItems="center"}function g(A,U){A.setAttribute("width","24"),A.setAttribute("id",U),A.setAttribute("height","24"),A.setAttribute("viewBox","0 0 24 24"),A.setAttribute("fill","none"),A.style.marginLeft="-6px"}function _(){const A=document.createElement("span");return A.style.cursor="pointer",A.style.marginLeft="16px",A.style.fontSize="24px",A.innerHTML=" &times;",A.onclick=()=>{ng=!0,h()},A}function w(A,U){A.setAttribute("id",U),A.innerText="Learn more",A.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",A.setAttribute("target","__blank"),A.style.paddingLeft="5px",A.style.textDecoration="underline"}function T(){const A=Ow(s),U=t("text"),q=document.getElementById(U)||document.createElement("span"),K=t("learnmore"),$=document.getElementById(K)||document.createElement("a"),de=t("preprendIcon"),ae=document.getElementById(de)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(A.created){const ue=A.element;m(ue),w($,K);const ve=_();g(ae,de),ue.append(ae,q,$,ve),document.body.appendChild(ue)}l?(q.innerText="Preview backend disconnected.",ae.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function j0(r,e){const t=Kd(r,"auth");if(t.isInitialized()){const o=t.getImmediate(),l=t.getOptions();if(ls(l,e??{}))return o;Bn(o,"already-initialized")}return t.initialize({options:e})}function z0(r,e){const t=(e==null?void 0:e.persistence)||[],s=(Array.isArray(t)?t:[t]).map(Nr);e!=null&&e.errorMap&&r._updateErrorMap(e.errorMap),r._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}function B0(r,e,t){const s=ms(r);ge(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const o=!1,l=g_(e),{host:h,port:m}=$0(e),g=m===null?"":`:${m}`,_={url:`${l}//${h}${g}/`},w=Object.freeze({host:h,port:m,protocol:l.replace(":",""),options:Object.freeze({disableWarnings:o})});if(!s._canInitEmulator){ge(s.config.emulator&&s.emulatorConfig,s,"emulator-config-failed"),ge(ls(_,s.config.emulator)&&ls(w,s.emulatorConfig),s,"emulator-config-failed");return}s.config.emulator=_,s.emulatorConfig=w,s.settings.appVerificationDisabledForTesting=!0,Po(h)?($y(`${l}//${h}${g}`),Wy("Auth",!0)):W0()}function g_(r){const e=r.indexOf(":");return e<0?"":r.substr(0,e+1)}function $0(r){const e=g_(r),t=/(\/\/)?([^?#/]+)/.exec(r.substr(e.length));if(!t)return{host:"",port:null};const s=t[2].split("@").pop()||"",o=/^(\[[^\]]+\])(:|$)/.exec(s);if(o){const l=o[1];return{host:l,port:Eg(s.substr(l.length+1))}}else{const[l,h]=s.split(":");return{host:l,port:Eg(h)}}}function Eg(r){if(!r)return null;const e=Number(r);return isNaN(e)?null:e}function W0(){function r(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",r):r())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Y0(r){switch(r){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function X0(r){const e=Da(Va(r)).link,t=e?Da(Va(e)).deep_link_id:null,s=Da(Va(r)).deep_link_id;return(s?Da(Va(s)).link:null)||s||t||e||r}class tf{constructor(e){var t,s,o,l,h,m;const g=Da(Va(e)),_=(t=g.apiKey)!==null&&t!==void 0?t:null,w=(s=g.oobCode)!==null&&s!==void 0?s:null,T=Y0((o=g.mode)!==null&&o!==void 0?o:null);ge(_&&w&&T,"argument-error"),this.apiKey=_,this.operation=T,this.code=w,this.continueUrl=(l=g.continueUrl)!==null&&l!==void 0?l:null,this.languageCode=(h=g.lang)!==null&&h!==void 0?h:null,this.tenantId=(m=g.tenantId)!==null&&m!==void 0?m:null}static parseLink(e){const t=X0(e);try{return new tf(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hI{constructor(e){this.target=e,this.handlers=new Set}removeMessageHandler(e){e.messageChannel&&(e.messageChannel.port1.removeEventListener("message",e.onMessage),e.messageChannel.port1.close()),this.handlers.delete(e)}async _send(e,t,s=50){const o=typeof MessageChannel<"u"?new MessageChannel:null;if(!o)throw new Error("connection_unavailable");let l,h;return new Promise((m,g)=>{const _=nf("",20);o.port1.start();const w=setTimeout(()=>{g(new Error("unsupported_event"))},s);h={messageChannel:o,onMessage(T){const A=T;if(A.data.eventId===_)switch(A.data.status){case"ack":clearTimeout(w),l=setTimeout(()=>{g(new Error("timeout"))},3e3);break;case"done":clearTimeout(l),m(A.data.response);break;default:clearTimeout(w),clearTimeout(l),g(new Error("invalid_response"));break}}},this.handlers.add(h),o.port1.addEventListener("message",h.onMessage),this.target.postMessage({eventType:e,eventId:_,data:t},[o.port2])}).finally(()=>{h&&this.removeMessageHandler(h)})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var _i,V_;(function(){var r;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(D,S){function C(){}C.prototype=S.prototype,D.D=S.prototype,D.prototype=new C,D.prototype.constructor=D,D.C=function(k,V,O){for(var R=Array(arguments.length-2),nt=2;nt<arguments.length;nt++)R[nt-2]=arguments[nt];return S.prototype[V].apply(k,R)}}function t(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(s,t),s.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function o(D,S,C){C||(C=0);var k=Array(16);if(typeof S=="string")for(var V=0;16>V;++V)k[V]=S.charCodeAt(C++)|S.charCodeAt(C++)<<8|S.charCodeAt(C++)<<16|S.charCodeAt(C++)<<24;else for(V=0;16>V;++V)k[V]=S[C++]|S[C++]<<8|S[C++]<<16|S[C++]<<24;S=D.g[0],C=D.g[1],V=D.g[2];var O=D.g[3],R=S+(O^C&(V^O))+k[0]+3614090360&4294967295;S=C+(R<<7&4294967295|R>>>25),R=O+(V^S&(C^V))+k[1]+3905402710&4294967295,O=S+(R<<12&4294967295|R>>>20),R=V+(C^O&(S^C))+k[2]+606105819&4294967295,V=O+(R<<17&4294967295|R>>>15),R=C+(S^V&(O^S))+k[3]+3250441966&4294967295,C=V+(R<<22&4294967295|R>>>10),R=S+(O^C&(V^O))+k[4]+4118548399&4294967295,S=C+(R<<7&4294967295|R>>>25),R=O+(V^S&(C^V))+k[5]+1200080426&4294967295,O=S+(R<<12&4294967295|R>>>20),R=V+(C^O&(S^C))+k[6]+2821735955&4294967295,V=O+(R<<17&4294967295|R>>>15),R=C+(S^V&(O^S))+k[7]+4249261313&4294967295,C=V+(R<<22&4294967295|R>>>10),R=S+(O^C&(V^O))+k[8]+1770035416&4294967295,S=C+(R<<7&4294967295|R>>>25),R=O+(V^S&(C^V))+k[9]+2336552879&4294967295,O=S+(R<<12&4294967295|R>>>20),R=V+(C^O&(S^C))+k[10]+4294925233&4294967295,V=O+(R<<17&4294967295|R>>>15),R=C+(S^V&(O^S))+k[11]+2304563134&4294967295,C=V+(R<<22&4294967295|R>>>10),R=S+(O^C&(V^O))+k[12]+1804603682&4294967295,S=C+(R<<7&4294967295|R>>>25),R=O+(V^S&(C^V))+k[13]+4254626195&4294967295,O=S+(R<<12&4294967295|R>>>20),R=V+(C^O&(S^C))+k[14]+2792965006&4294967295,V=O+(R<<17&4294967295|R>>>15),R=C+(S^V&(O^S))+k[15]+1236535329&4294967295,C=V+(R<<22&4294967295|R>>>10),R=S+(V^O&(C^V))+k[1]+4129170786&4294967295,S=C+(R<<5&4294967295|R>>>27),R=O+(C^V&(S^C))+k[6]+3225465664&4294967295,O=S+(R<<9&4294967295|R>>>23),R=V+(S^C&(O^S))+k[11]+643717713&4294967295,V=O+(R<<14&4294967295|R>>>18),R=C+(O^S&(V^O))+k[0]+3921069994&4294967295,C=V+(R<<20&4294967295|R>>>12),R=S+(V^O&(C^V))+k[5]+3593408605&4294967295,S=C+(R<<5&4294967295|R>>>27),R=O+(C^V&(S^C))+k[10]+38016083&4294967295,O=S+(R<<9&4294967295|R>>>23),R=V+(S^C&(O^S))+k[15]+3634488961&4294967295,V=O+(R<<14&4294967295|R>>>18),R=C+(O^S&(V^O))+k[4]+3889429448&4294967295,C=V+(R<<20&4294967295|R>>>12),R=S+(V^O&(C^V))+k[9]+568446438&4294967295,S=C+(R<<5&4294967295|R>>>27),R=O+(C^V&(S^C))+k[14]+3275163606&4294967295,O=S+(R<<9&4294967295|R>>>23),R=V+(S^C&(O^S))+k[3]+4107603335&4294967295,V=O+(R<<14&4294967295|R>>>18),R=C+(O^S&(V^O))+k[8]+1163531501&4294967295,C=V+(R<<20&4294967295|R>>>12),R=S+(V^O&(C^V))+k[13]+2850285829&4294967295,S=C+(R<<5&4294967295|R>>>27),R=O+(C^V&(S^C))+k[2]+4243563512&4294967295,O=S+(R<<9&4294967295|R>>>23),R=V+(S^C&(O^S))+k[7]+1735328473&4294967295,V=O+(R<<14&4294967295|R>>>18),R=C+(O^S&(V^O))+k[12]+2368359562&4294967295,C=V+(R<<20&4294967295|R>>>12),R=S+(C^V^O)+k[5]+4294588738&4294967295,S=C+(R<<4&4294967295|R>>>28),R=O+(S^C^V)+k[8]+2272392833&4294967295,O=S+(R<<11&4294967295|R>>>21),R=V+(O^S^C)+k[11]+1839030562&4294967295,V=O+(R<<16&4294967295|R>>>16),R=C+(V^O^S)+k[14]+4259657740&4294967295,C=V+(R<<23&4294967295|R>>>9),R=S+(C^V^O)+k[1]+2763975236&4294967295,S=C+(R<<4&4294967295|R>>>28),R=O+(S^C^V)+k[4]+1272893353&4294967295,O=S+(R<<11&4294967295|R>>>21),R=V+(O^S^C)+k[7]+4139469664&4294967295,V=O+(R<<16&4294967295|R>>>16),R=C+(V^O^S)+k[10]+3200236656&4294967295,C=V+(R<<23&4294967295|R>>>9),R=S+(C^V^O)+k[13]+681279174&4294967295,S=C+(R<<4&4294967295|R>>>28),R=O+(S^C^V)+k[0]+3936430074&4294967295,O=S+(R<<11&4294967295|R>>>21),R=V+(O^S^C)+k[3]+3572445317&4294967295,V=O+(R<<16&4294967295|R>>>16),R=C+(V^O^S)+k[6]+76029189&4294967295,C=V+(R<<23&4294967295|R>>>9),R=S+(C^V^O)+k[9]+3654602809&4294967295,S=C+(R<<4&4294967295|R>>>28),R=O+(S^C^V)+k[12]+3873151461&4294967295,O=S+(R<<11&4294967295|R>>>21),R=V+(O^S^C)+k[15]+530742520&4294967295,V=O+(R<<16&4294967295|R>>>16),R=C+(V^O^S)+k[2]+3299628645&4294967295,C=V+(R<<23&4294967295|R>>>9),R=S+(V^(C|~O))+k[0]+4096336452&4294967295,S=C+(R<<6&4294967295|R>>>26),R=O+(C^(S|~V))+k[7]+1126891415&4294967295,O=S+(R<<10&4294967295|R>>>22),R=V+(S^(O|~C))+k[14]+2878612391&4294967295,V=O+(R<<15&4294967295|R>>>17),R=C+(O^(V|~S))+k[5]+4237533241&4294967295,C=V+(R<<21&4294967295|R>>>11),R=S+(V^(C|~O))+k[12]+1700485571&4294967295,S=C+(R<<6&4294967295|R>>>26),R=O+(C^(S|~V))+k[3]+2399980690&4294967295,O=S+(R<<10&4294967295|R>>>22),R=V+(S^(O|~C))+k[10]+4293915773&4294967295,V=O+(R<<15&4294967295|R>>>17),R=C+(O^(V|~S))+k[1]+2240044497&4294967295,C=V+(R<<21&4294967295|R>>>11),R=S+(V^(C|~O))+k[8]+1873313359&4294967295,S=C+(R<<6&4294967295|R>>>26),R=O+(C^(S|~V))+k[15]+4264355552&4294967295,O=S+(R<<10&4294967295|R>>>22),R=V+(S^(O|~C))+k[6]+2734768916&4294967295,V=O+(R<<15&4294967295|R>>>17),R=C+(O^(V|~S))+k[13]+1309151649&4294967295,C=V+(R<<21&4294967295|R>>>11),R=S+(V^(C|~O))+k[4]+4149444226&4294967295,S=C+(R<<6&4294967295|R>>>26),R=O+(C^(S|~V))+k[11]+3174756917&4294967295,O=S+(R<<10&4294967295|R>>>22),R=V+(S^(O|~C))+k[2]+718787259&4294967295,V=O+(R<<15&4294967295|R>>>17),R=C+(O^(V|~S))+k[9]+3951481745&4294967295,D.g[0]=D.g[0]+S&4294967295,D.g[1]=D.g[1]+(V+(R<<21&4294967295|R>>>11))&4294967295,D.g[2]=D.g[2]+V&4294967295,D.g[3]=D.g[3]+O&4294967295}s.prototype.u=function(D,S){S===void 0&&(S=D.length);for(var C=S-this.blockSize,k=this.B,V=this.h,O=0;O<S;){if(V==0)for(;O<=C;)o(this,D,O),O+=this.blockSize;if(typeof D=="string"){for(;O<S;)if(k[V++]=D.charCodeAt(O++),V==this.blockSize){o(this,k),V=0;break}}else for(;O<S;)if(k[V++]=D[O++],V==this.blockSize){o(this,k),V=0;break}}this.h=V,this.o+=S},s.prototype.v=function(){var D=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);D[0]=128;for(var S=1;S<D.length-8;++S)D[S]=0;var C=8*this.o;for(S=D.length-8;S<D.length;++S)D[S]=C&255,C/=256;for(this.u(D),D=Array(16),S=C=0;4>S;++S)for(var k=0;32>k;k+=8)D[C++]=this.g[S]>>>k&255;return D};function l(D,S){var C=m;return Object.prototype.hasOwnProperty.call(C,D)?C[D]:C[D]=S(D)}function h(D,S){this.h=S;for(var C=[],k=!0,V=D.length-1;0<=V;V--){var O=D[V]|0;k&&O==S||(C[V]=O,k=!1)}this.g=C}var m={};function g(D){return-128<=D&&128>D?l(D,function(S){return new h([S|0],0>S?-1:0)}):new h([D|0],0>D?-1:0)}function _(D){if(isNaN(D)||!isFinite(D))return T;if(0>D)return $(_(-D));for(var S=[],C=1,k=0;D>=C;k++)S[k]=D/C|0,C*=4294967296;return new h(S,0)}function w(D,S){if(D.length==0)throw Error("number format error: empty string");if(S=S||10,2>S||36<S)throw Error("radix out of range: "+S);if(D.charAt(0)=="-")return $(w(D.substring(1),S));if(0<=D.indexOf("-"))throw Error('number format error: interior "-" character');for(var C=_(Math.pow(S,8)),k=T,V=0;V<D.length;V+=8){var O=Math.min(8,D.length-V),R=parseInt(D.substring(V,V+O),S);8>O?(O=_(Math.pow(S,O)),k=k.j(O).add(_(R))):(k=k.j(C),k=k.add(_(R)))}return k}var T=g(0),A=g(1),U=g(16777216);r=h.prototype,r.m=function(){if(K(this))return-$(this).m();for(var D=0,S=1,C=0;C<this.g.length;C++){var k=this.i(C);D+=(0<=k?k:4294967296+k)*S,S*=4294967296}return D},r.toString=function(D){if(D=D||10,2>D||36<D)throw Error("radix out of range: "+D);if(q(this))return"0";if(K(this))return"-"+$(this).toString(D);for(var S=_(Math.pow(D,6)),C=this,k="";;){var V=ve(C,S).g;C=de(C,V.j(S));var O=((0<C.g.length?C.g[0]:C.h)>>>0).toString(D);if(C=V,q(C))return O+k;for(;6>O.length;)O="0"+O;k=O+k}},r.i=function(D){return 0>D?0:D<this.g.length?this.g[D]:this.h};function q(D){if(D.h!=0)return!1;for(var S=0;S<D.g.length;S++)if(D.g[S]!=0)return!1;return!0}function K(D){return D.h==-1}r.l=function(D){return D=de(this,D),K(D)?-1:q(D)?0:1};function $(D){for(var S=D.g.length,C=[],k=0;k<S;k++)C[k]=~D.g[k];return new h(C,~D.h).add(A)}r.abs=function(){return K(this)?$(this):this},r.add=function(D){for(var S=Math.max(this.g.length,D.g.length),C=[],k=0,V=0;V<=S;V++){var O=k+(this.i(V)&65535)+(D.i(V)&65535),R=(O>>>16)+(this.i(V)>>>16)+(D.i(V)>>>16);k=R>>>16,O&=65535,R&=65535,C[V]=R<<16|O}return new h(C,C[C.length-1]&-2147483648?-1:0)};function de(D,S){return D.add($(S))}r.j=function(D){if(q(this)||q(D))return T;if(K(this))return K(D)?$(this).j($(D)):$($(this).j(D));if(K(D))return $(this.j($(D)));if(0>this.l(U)&&0>D.l(U))return _(this.m()*D.m());for(var S=this.g.length+D.g.length,C=[],k=0;k<2*S;k++)C[k]=0;for(k=0;k<this.g.length;k++)for(var V=0;V<D.g.length;V++){var O=this.i(k)>>>16,R=this.i(k)&65535,nt=D.i(V)>>>16,Dt=D.i(V)&65535;C[2*k+2*V]+=R*Dt,ae(C,2*k+2*V),C[2*k+2*V+1]+=O*Dt,ae(C,2*k+2*V+1),C[2*k+2*V+1]+=R*nt,ae(C,2*k+2*V+1),C[2*k+2*V+2]+=O*nt,ae(C,2*k+2*V+2)}for(k=0;k<S;k++)C[k]=C[2*k+1]<<16|C[2*k];for(k=S;k<2*S;k++)C[k]=0;return new h(C,0)};function ae(D,S){for(;(D[S]&65535)!=D[S];)D[S+1]+=D[S]>>>16,D[S]&=65535,S++}function ue(D,S){this.g=D,this.h=S}function ve(D,S){if(q(S))throw Error("division by zero");if(q(D))return new ue(T,T);if(K(D))return S=ve($(D),S),new ue($(S.g),$(S.h));if(K(S))return S=ve(D,$(S)),new ue($(S.g),S.h);if(30<D.g.length){if(K(D)||K(S))throw Error("slowDivide_ only works with positive integers.");for(var C=A,k=S;0>=k.l(D);)C=Ue(C),k=Ue(k);var V=Te(C,1),O=Te(k,1);for(k=Te(k,2),C=Te(C,2);!q(k);){var R=O.add(k);0>=R.l(D)&&(V=V.add(C),O=R),k=Te(k,1),C=Te(C,1)}return S=de(D,V.j(S)),new ue(V,S)}for(V=T;0<=D.l(S);){for(C=Math.max(1,Math.floor(D.m()/S.m())),k=Math.ceil(Math.log(C)/Math.LN2),k=48>=k?1:Math.pow(2,k-48),O=_(C),R=O.j(S);K(R)||0<R.l(D);)C-=k,O=_(C),R=O.j(S);q(O)&&(O=A),V=V.add(O),D=de(D,R)}return new ue(V,D)}r.A=function(D){return ve(this,D).h},r.and=function(D){for(var S=Math.max(this.g.length,D.g.length),C=[],k=0;k<S;k++)C[k]=this.i(k)&D.i(k);return new h(C,this.h&D.h)},r.or=function(D){for(var S=Math.max(this.g.length,D.g.length),C=[],k=0;k<S;k++)C[k]=this.i(k)|D.i(k);return new h(C,this.h|D.h)},r.xor=function(D){for(var S=Math.max(this.g.length,D.g.length),C=[],k=0;k<S;k++)C[k]=this.i(k)^D.i(k);return new h(C,this.h^D.h)};function Ue(D){for(var S=D.g.length+1,C=[],k=0;k<S;k++)C[k]=D.i(k)<<1|D.i(k-1)>>>31;return new h(C,D.h)}function Te(D,S){var C=S>>5;S%=32;for(var k=D.g.length-C,V=[],O=0;O<k;O++)V[O]=0<S?D.i(O+C)>>>S|D.i(O+C+1)<<32-S:D.i(O+C);return new h(V,D.h)}s.prototype.digest=s.prototype.v,s.prototype.reset=s.prototype.s,s.prototype.update=s.prototype.u,V_=s,h.prototype.add=h.prototype.add,h.prototype.multiply=h.prototype.j,h.prototype.modulo=h.prototype.A,h.prototype.compare=h.prototype.l,h.prototype.toNumber=h.prototype.m,h.prototype.toString=h.prototype.toString,h.prototype.getBits=h.prototype.i,h.fromNumber=_,h.fromString=w,_i=h}).apply(typeof Dg<"u"?Dg:typeof self<"u"?self:typeof window<"u"?window:{});var ku=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ye(r,e,t){let s="Unexpected state";typeof e=="string"?s=e:t=e,F_(r,s,t)}function F_(r,e,t){let s=`FIRESTORE (${Do}) INTERNAL ASSERTION FAILED: ${e} (ID: ${r.toString(16)})`;if(t!==void 0)try{s+=" CONTEXT: "+JSON.stringify(t)}catch{s+=" CONTEXT: "+t}throw Lr(s),new Error(s)}function Fe(r,e,t,s){let o="Unexpected state";typeof t=="string"?o=t:s=t,r||F_(e,o,s)}function we(r,e){return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ht(r,e){const t={typeString:r};return e&&(t.value=e),t}function ll(r,e){if(!B_(r))throw new ee(B.INVALID_ARGUMENT,"JSON must be an object");let t;for(const s in e)if(e[s]){const o=e[s].typeString,l="value"in e[s]?{value:e[s].value}:void 0;if(!(s in r)){t=`JSON missing required field: '${s}'`;break}const h=r[s];if(o&&typeof h!==o){t=`JSON field '${s}' must be a ${o}.`;break}if(l!==void 0&&h!==l.value){t=`Expected '${s}' field to equal '${l.value}'`;break}}if(t)throw new ee(B.INVALID_ARGUMENT,t);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vo(r){if(r.code!==B.FAILED_PRECONDITION||r.message!==OS)throw r;ne("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sA=new et(he.comparator);function Mr(){return sA}const lv=new et(he.comparator);function Oa(...r){let e=lv;for(const t of r)e=e.insert(t.key,t);return e}function uv(r){let e=lv;return r.forEach(((t,s)=>e=e.insert(t,s.overlayedDocument))),e}function ss(){return za()}function cv(){return za()}function za(){return new ys((r=>r.toString()),((r,e)=>r.isEqual(e)))}const oA=new et(he.comparator),aA=new yt(he.comparator);function Pe(...r){let e=aA;for(const t of r)e=e.add(t);return e}const lA=new yt(Se);function uA(){return lA}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gf{constructor(){this.qr=new yt(It.Qr),this.$r=new yt(It.Ur)}isEmpty(){return this.qr.isEmpty()}addReference(e,t){const s=new It(e,t);this.qr=this.qr.add(s),this.$r=this.$r.add(s)}Kr(e,t){e.forEach((s=>this.addReference(s,t)))}removeReference(e,t){this.Wr(new It(e,t))}Gr(e,t){e.forEach((s=>this.removeReference(s,t)))}zr(e){const t=new he(new qe([])),s=new It(t,e),o=new It(t,e+1),l=[];return this.$r.forEachInRange([s,o],(h=>{this.Wr(h),l.push(h.key)})),l}jr(){this.qr.forEach((e=>this.Wr(e)))}Wr(e){this.qr=this.qr.delete(e),this.$r=this.$r.delete(e)}Jr(e){const t=new he(new qe([])),s=new It(t,e),o=new It(t,e+1);let l=Pe();return this.$r.forEachInRange([s,o],(h=>{l=l.add(h.key)})),l}containsKey(e){const t=new It(e,0),s=this.qr.firstAfterOrEqual(t);return s!==null&&e.isEqual(s.key)}}class It{constructor(e,t){this.key=e,this.Hr=t}static Qr(e,t){return he.comparator(e.key,t.key)||Se(e.Hr,t.Hr)}static Ur(e,t){return Se(e.Hr,t.Hr)||he.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fd="RestConnection",w1={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class T1{get Qo(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),o=encodeURIComponent(this.databaseId.database);this.$o=t+"://"+e.host,this.Uo=`projects/${s}/databases/${o}`,this.Ko=this.databaseId.database===ec?`project_id=${s}`:`project_id=${s}&database_id=${o}`}Wo(e,t,s,o,l){const h=zd(),m=this.Go(e,t.toUriEncodedString());ne(fd,`Sending RPC '${e}' ${h}:`,m,s);const g={"google-cloud-resource-prefix":this.Uo,"x-goog-request-params":this.Ko};this.zo(g,o,l);const{host:_}=new URL(m),w=Po(_);return this.jo(e,m,g,s,w).then((T=>(ne(fd,`Received RPC '${e}' ${h}: `,T),T)),(T=>{throw Ei(fd,`RPC '${e}' ${h} failed with error: `,T,"url: ",m,"request:",s),T}))}Jo(e,t,s,o,l,h){return this.Wo(e,t,s,o,l)}zo(e,t,s){e["X-Goog-Api-Client"]=(function(){return"gl-js/ fire/"+Do})(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach(((o,l)=>e[l]=o)),s&&s.headers.forEach(((o,l)=>e[l]=o))}Go(e,t){const s=w1[e];return`${this.$o}/v1/${t}:${s}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bt="WebChannelConnection";class S1 extends T1{constructor(e){super(e),this.u_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}jo(e,t,s,o,l){const h=zd();return new Promise(((m,g)=>{const _=new x_;_.setWithCredentials(!0),_.listenOnce(O_.COMPLETE,(()=>{try{switch(_.getLastErrorCode()){case Uu.NO_ERROR:const T=_.getResponseJson();ne(bt,`XHR for RPC '${e}' ${h} received:`,JSON.stringify(T)),m(T);break;case Uu.TIMEOUT:ne(bt,`RPC '${e}' ${h} timed out`),g(new ee(B.DEADLINE_EXCEEDED,"Request time out"));break;case Uu.HTTP_ERROR:const A=_.getStatus();if(ne(bt,`RPC '${e}' ${h} failed with status:`,A,"response text:",_.getResponseText()),A>0){let U=_.getResponseJson();Array.isArray(U)&&(U=U[0]);const q=U==null?void 0:U.error;if(q&&q.status&&q.message){const K=(function(de){const ae=de.toLowerCase().replace(/_/g,"-");return Object.values(B).indexOf(ae)>=0?ae:B.UNKNOWN})(q.status);g(new ee(K,q.message))}else g(new ee(B.UNKNOWN,"Server responded with status "+_.getStatus()))}else g(new ee(B.UNAVAILABLE,"Connection failed."));break;default:ye(9055,{c_:e,streamId:h,l_:_.getLastErrorCode(),h_:_.getLastError()})}}finally{ne(bt,`RPC '${e}' ${h} completed.`)}}));const w=JSON.stringify(o);ne(bt,`RPC '${e}' ${h} sending request:`,o),_.send(t,"POST",w,s,15)}))}P_(e,t,s){const o=zd(),l=[this.$o,"/","google.firestore.v1.Firestore","/",e,"/channel"],h=b_(),m=M_(),g={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},_=this.longPollingOptions.timeoutSeconds;_!==void 0&&(g.longPollingTimeout=Math.round(1e3*_)),this.useFetchStreams&&(g.useFetchStreams=!0),this.zo(g.initMessageHeaders,t,s),g.encodeInitMessageHeaders=!0;const w=l.join("");ne(bt,`Creating RPC '${e}' stream ${o}: ${w}`,g);const T=h.createWebChannel(w,g);this.T_(T);let A=!1,U=!1;const q=new I1({Ho:$=>{U?ne(bt,`Not sending because RPC '${e}' stream ${o} is closed:`,$):(A||(ne(bt,`Opening RPC '${e}' stream ${o} transport.`),T.open(),A=!0),ne(bt,`RPC '${e}' stream ${o} sending:`,$),T.send($))},Yo:()=>T.close()}),K=($,de,ae)=>{$.listen(de,(ue=>{try{ae(ue)}catch(ve){setTimeout((()=>{throw ve}),0)}}))};return K(T,xa.EventType.OPEN,(()=>{U||(ne(bt,`RPC '${e}' stream ${o} transport opened.`),q.s_())})),K(T,xa.EventType.CLOSE,(()=>{U||(U=!0,ne(bt,`RPC '${e}' stream ${o} transport closed`),q.__(),this.I_(T))})),K(T,xa.EventType.ERROR,($=>{U||(U=!0,Ei(bt,`RPC '${e}' stream ${o} transport errored. Name:`,$.name,"Message:",$.message),q.__(new ee(B.UNAVAILABLE,"The operation could not be completed")))})),K(T,xa.EventType.MESSAGE,($=>{var de;if(!U){const ae=$.data[0];Fe(!!ae,16349);const ue=ae,ve=(ue==null?void 0:ue.error)||((de=ue[0])===null||de===void 0?void 0:de.error);if(ve){ne(bt,`RPC '${e}' stream ${o} received error:`,ve);const Ue=ve.status;let Te=(function(C){const k=ut[C];if(k!==void 0)return vv(k)})(Ue),D=ve.message;Te===void 0&&(Te=B.INTERNAL,D="Unknown error status: "+Ue+" with message "+ve.message),U=!0,q.__(new ee(Te,D)),T.close()}else ne(bt,`RPC '${e}' stream ${o} received:`,ae),q.a_(ae)}})),K(m,L_.STAT_EVENT,($=>{$.stat===Pd.PROXY?ne(bt,`RPC '${e}' stream ${o} detected buffering proxy`):$.stat===Pd.NOPROXY&&ne(bt,`RPC '${e}' stream ${o} detected no buffering proxy`)})),setTimeout((()=>{q.o_()}),0),q}terminate(){this.u_.forEach((e=>e.close())),this.u_=[]}T_(e){this.u_.push(e)}I_(e){this.u_=this.u_.filter((t=>t===e))}}function pd(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const my="PersistentStream";class Ov{constructor(e,t,s,o,l,h,m,g){this.Fi=e,this.w_=s,this.S_=o,this.connection=l,this.authCredentialsProvider=h,this.appCheckCredentialsProvider=m,this.listener=g,this.state=0,this.b_=0,this.D_=null,this.v_=null,this.stream=null,this.C_=0,this.F_=new xv(e,t)}M_(){return this.state===1||this.state===5||this.x_()}x_(){return this.state===2||this.state===3}start(){this.C_=0,this.state!==4?this.auth():this.O_()}async stop(){this.M_()&&await this.close(0)}N_(){this.state=0,this.F_.reset()}B_(){this.x_()&&this.D_===null&&(this.D_=this.Fi.enqueueAfterDelay(this.w_,6e4,(()=>this.L_())))}k_(e){this.q_(),this.stream.send(e)}async L_(){if(this.x_())return this.close(0)}q_(){this.D_&&(this.D_.cancel(),this.D_=null)}Q_(){this.v_&&(this.v_.cancel(),this.v_=null)}async close(e,t){this.q_(),this.Q_(),this.F_.cancel(),this.b_++,e!==4?this.F_.reset():t&&t.code===B.RESOURCE_EXHAUSTED?(Lr(t.toString()),Lr("Using maximum backoff delay to prevent overloading the backend."),this.F_.f_()):t&&t.code===B.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.U_(),this.stream.close(),this.stream=null),this.state=e,await this.listener.n_(t)}U_(){}auth(){this.state=1;const e=this.K_(this.b_),t=this.b_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then((([s,o])=>{this.b_===t&&this.W_(s,o)}),(s=>{e((()=>{const o=new ee(B.UNKNOWN,"Fetching auth token failed: "+s.message);return this.G_(o)}))}))}W_(e,t){const s=this.K_(this.b_);this.stream=this.z_(e,t),this.stream.Zo((()=>{s((()=>this.listener.Zo()))})),this.stream.e_((()=>{s((()=>(this.state=2,this.v_=this.Fi.enqueueAfterDelay(this.S_,1e4,(()=>(this.x_()&&(this.state=3),Promise.resolve()))),this.listener.e_())))})),this.stream.n_((o=>{s((()=>this.G_(o)))})),this.stream.onMessage((o=>{s((()=>++this.C_==1?this.j_(o):this.onNext(o)))}))}O_(){this.state=5,this.F_.g_((async()=>{this.state=0,this.start()}))}G_(e){return ne(my,`close with error: ${e}`),this.stream=null,this.close(4,e)}K_(e){return t=>{this.Fi.enqueueAndForget((()=>this.b_===e?t():(ne(my,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve())))}}}class A1 extends Ov{constructor(e,t,s,o,l,h){super(e,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",t,s,o,h),this.serializer=l}z_(e,t){return this.connection.P_("Listen",e,t)}j_(e){return this.onNext(e)}onNext(e){this.F_.reset();const t=DA(this.serializer,e),s=(function(l){if(!("targetChange"in l))return Ee.min();const h=l.targetChange;return h.targetIds&&h.targetIds.length?Ee.min():h.readTime?or(h.readTime):Ee.min()})(e);return this.listener.J_(t,s)}H_(e){const t={};t.database=Ud(this.serializer),t.addTarget=(function(l,h){let m;const g=h.target;if(m=xd(g)?{documents:OA(l,g)}:{query:LA(l,g).Vt},m.targetId=h.targetId,h.resumeToken.approximateByteSize()>0){m.resumeToken=Tv(l,h.resumeToken);const _=Md(l,h.expectedCount);_!==null&&(m.expectedCount=_)}else if(h.snapshotVersion.compareTo(Ee.min())>0){m.readTime=ic(l,h.snapshotVersion.toTimestamp());const _=Md(l,h.expectedCount);_!==null&&(m.expectedCount=_)}return m})(this.serializer,e);const s=bA(this.serializer,e);s&&(t.labels=s),this.k_(t)}Y_(e){const t={};t.database=Ud(this.serializer),t.removeTarget=e,this.k_(t)}}class R1 extends Ov{constructor(e,t,s,o,l,h){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",t,s,o,h),this.serializer=l}get Z_(){return this.C_>0}start(){this.lastStreamToken=void 0,super.start()}U_(){this.Z_&&this.X_([])}z_(e,t){return this.connection.P_("Write",e,t)}j_(e){return Fe(!!e.streamToken,31322),this.lastStreamToken=e.streamToken,Fe(!e.writeResults||e.writeResults.length===0,55816),this.listener.ea()}onNext(e){Fe(!!e.streamToken,12678),this.lastStreamToken=e.streamToken,this.F_.reset();const t=xA(e.writeResults,e.commitTime),s=or(e.commitTime);return this.listener.ta(s,t)}na(){const e={};e.database=Ud(this.serializer),this.k_(e)}X_(e){const t={streamToken:this.lastStreamToken,writes:e.map((s=>VA(this.serializer,s)))};this.k_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yy{constructor(){this.fa=new et(he.comparator)}track(e){const t=e.doc.key,s=this.fa.get(t);s?e.type!==0&&s.type===3?this.fa=this.fa.insert(t,e):e.type===3&&s.type!==1?this.fa=this.fa.insert(t,{type:s.type,doc:e.doc}):e.type===2&&s.type===2?this.fa=this.fa.insert(t,{type:2,doc:e.doc}):e.type===2&&s.type===0?this.fa=this.fa.insert(t,{type:0,doc:e.doc}):e.type===1&&s.type===0?this.fa=this.fa.remove(t):e.type===1&&s.type===2?this.fa=this.fa.insert(t,{type:1,doc:s.doc}):e.type===0&&s.type===1?this.fa=this.fa.insert(t,{type:2,doc:e.doc}):ye(63341,{At:e,ga:s}):this.fa=this.fa.insert(t,e)}pa(){const e=[];return this.fa.inorderTraversal(((t,s)=>{e.push(s)})),e}}class Co{constructor(e,t,s,o,l,h,m,g,_){this.query=e,this.docs=t,this.oldDocs=s,this.docChanges=o,this.mutatedKeys=l,this.fromCache=h,this.syncStateChanged=m,this.excludesMetadataChanges=g,this.hasCachedResults=_}static fromInitialDocuments(e,t,s,o,l){const h=[];return t.forEach((m=>{h.push({type:0,doc:m})})),new Co(e,t,wo.emptySet(t),h,s,o,!0,!1,l)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&wc(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const t=this.docChanges,s=e.docChanges;if(t.length!==s.length)return!1;for(let o=0;o<t.length;o++)if(t[o].type!==s[o].type||!t[o].doc.isEqual(s[o].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ki{constructor(e,t,s){this.converter=t,this._query=s,this.type="query",this.firestore=e}withConverter(e){return new ki(this.firestore,e,this._query)}}class ot{constructor(e,t,s){this.converter=t,this._key=s,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new vi(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new ot(this.firestore,e,this._key)}toJSON(){return{type:ot._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(e,t,s){if(ll(t,ot._jsonSchema))return new ot(e,s||null,new he(qe.fromString(t.referencePath)))}}ot._jsonSchemaVersion="firestore/documentReference/1.0",ot._jsonSchema={type:ht("string",ot._jsonSchemaVersion),referencePath:ht("string")};class vi extends ki{constructor(e,t,s){super(e,t,Ec(s)),this._path=s,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new ot(this.firestore,null,new he(e))}withConverter(e){return new vi(this.firestore,e,this._path)}}function uc(r,e,...t){if(r=zt(r),z_("collection","path",e),r instanceof kc){const s=qe.fromString(e,...t);return Fg(s),new vi(r,null,s)}{if(!(r instanceof ot||r instanceof vi))throw new ee(B.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=r._path.child(qe.fromString(e,...t));return Fg(s),new vi(r.firestore,null,s)}}function ar(r,e,...t){if(r=zt(r),arguments.length===1&&(e=of.newId()),z_("doc","path",e),r instanceof kc){const s=qe.fromString(e,...t);return bg(s),new ot(r,null,new he(s))}{if(!(r instanceof ot||r instanceof vi))throw new ee(B.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=r._path.child(qe.fromString(e,...t));return bg(s),new ot(r.firestore,r instanceof vi?r.converter:null,new he(s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xf{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new ee(B.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new kt(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Vy;function VR(){return Vy||(Vy=1,(function(r){function e(Z,fe){var re=Z.length;Z.push(fe);e:for(;0<re;){var x=re-1>>>1,H=Z[x];if(0<o(H,fe))Z[x]=fe,Z[re]=H,re=x;else break e}}function t(Z){return Z.length===0?null:Z[0]}function s(Z){if(Z.length===0)return null;var fe=Z[0],re=Z.pop();if(re!==fe){Z[0]=re;e:for(var x=0,H=Z.length,ce=H>>>1;x<ce;){var Ie=2*(x+1)-1,Ae=Z[Ie],Ne=Ie+1,Le=Z[Ne];if(0>o(Ae,re))Ne<H&&0>o(Le,Ae)?(Z[x]=Le,Z[Ne]=re,x=Ne):(Z[x]=Ae,Z[Ie]=re,x=Ie);else if(Ne<H&&0>o(Le,re))Z[x]=Le,Z[Ne]=re,x=Ne;else break e}}return fe}function o(Z,fe){var re=Z.sortIndex-fe.sortIndex;return re!==0?re:Z.id-fe.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;r.unstable_now=function(){return l.now()}}else{var h=Date,m=h.now();r.unstable_now=function(){return h.now()-m}}var g=[],_=[],w=1,T=null,A=3,U=!1,q=!1,K=!1,$=typeof setTimeout=="function"?setTimeout:null,de=typeof clearTimeout=="function"?clearTimeout:null,ae=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function ue(Z){for(var fe=t(_);fe!==null;){if(fe.callback===null)s(_);else if(fe.startTime<=Z)s(_),fe.sortIndex=fe.expirationTime,e(g,fe);else break;fe=t(_)}}function ve(Z){if(K=!1,ue(Z),!q)if(t(g)!==null)q=!0,Vt(Ue);else{var fe=t(_);fe!==null&&ze(ve,fe.startTime-Z)}}function Ue(Z,fe){q=!1,K&&(K=!1,de(S),S=-1),U=!0;var re=A;try{for(ue(fe),T=t(g);T!==null&&(!(T.expirationTime>fe)||Z&&!V());){var x=T.callback;if(typeof x=="function"){T.callback=null,A=T.priorityLevel;var H=x(T.expirationTime<=fe);fe=r.unstable_now(),typeof H=="function"?T.callback=H:T===t(g)&&s(g),ue(fe)}else s(g);T=t(g)}if(T!==null)var ce=!0;else{var Ie=t(_);Ie!==null&&ze(ve,Ie.startTime-fe),ce=!1}return ce}finally{T=null,A=re,U=!1}}var Te=!1,D=null,S=-1,C=5,k=-1;function V(){return!(r.unstable_now()-k<C)}function O(){if(D!==null){var Z=r.unstable_now();k=Z;var fe=!0;try{fe=D(!0,Z)}finally{fe?R():(Te=!1,D=null)}}else Te=!1}var R;if(typeof ae=="function")R=function(){ae(O)};else if(typeof MessageChannel<"u"){var nt=new MessageChannel,Dt=nt.port2;nt.port1.onmessage=O,R=function(){Dt.postMessage(null)}}else R=function(){$(O,0)};function Vt(Z){D=Z,Te||(Te=!0,R())}function ze(Z,fe){S=$(function(){Z(r.unstable_now())},fe)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(Z){Z.callback=null},r.unstable_continueExecution=function(){q||U||(q=!0,Vt(Ue))},r.unstable_forceFrameRate=function(Z){0>Z||125<Z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):C=0<Z?Math.floor(1e3/Z):5},r.unstable_getCurrentPriorityLevel=function(){return A},r.unstable_getFirstCallbackNode=function(){return t(g)},r.unstable_next=function(Z){switch(A){case 1:case 2:case 3:var fe=3;break;default:fe=A}var re=A;A=fe;try{return Z()}finally{A=re}},r.unstable_pauseExecution=function(){},r.unstable_requestPaint=function(){},r.unstable_runWithPriority=function(Z,fe){switch(Z){case 1:case 2:case 3:case 4:case 5:break;default:Z=3}var re=A;A=Z;try{return fe()}finally{A=re}},r.unstable_scheduleCallback=function(Z,fe,re){var x=r.unstable_now();switch(typeof re=="object"&&re!==null?(re=re.delay,re=typeof re=="number"&&0<re?x+re:x):re=x,Z){case 1:var H=-1;break;case 2:H=250;break;case 5:H=1073741823;break;case 4:H=1e4;break;default:H=5e3}return H=re+H,Z={id:w++,callback:fe,priorityLevel:Z,startTime:re,expirationTime:H,sortIndex:-1},re>x?(Z.sortIndex=re,e(_,Z),t(g)===null&&Z===t(_)&&(K?(de(S),S=-1):K=!0,ze(ve,re-x))):(Z.sortIndex=H,e(g,Z),q||U||(q=!0,Vt(Ue))),Z},r.unstable_shouldYield=V,r.unstable_wrapCallback=function(Z){var fe=A;return function(){var re=A;A=fe;try{return Z.apply(this,arguments)}finally{A=re}}}})(_d)),_d}var xy;function xR(){return xy||(xy=1,yd.exports=VR()),yd.exports}/**
 * @license React
